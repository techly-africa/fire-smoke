...
export function Checkout({ tier, qty, total, onClose }: Props) {
  ...
  return (
    ...
    >
      <div
        style={{ background: C.bg, color: C.text, width: '100%', maxWidth: 520, maxHeight: '95dvh', overflowY: 'auto', padding: 'clamp(16px, 4vw, 24px)', position: 'relative', border: `3px solid ${C.yellow}`, borderBottom: 'none' }}
      ...
      >
        ...
        {step === 2 && (
          <>
            <h3 style={{ fontFamily: F.display, fontSize: 'clamp(24px, 6vw, 32px)', margin: '0 0 14px', letterSpacing: -0.5, lineHeight: 1 }}>PAY {total.toLocaleString()} RWF</h3>
        ...
        {step === 3 && (
          <div style={{ textAlign: 'center', padding: '6px 0' }}>
            <div style={{ fontFamily: F.display, fontSize: 'clamp(28px, 8vw, 40px)', color: C.yellow, lineHeight: 1, letterSpacing: -1 }}>✓ YOU'RE IN</div>
